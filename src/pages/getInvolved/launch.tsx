  ...
  return (
    <div className="max-width">
      <span className="body">
        ...
        <p>
          <img src="../images/launch.jpg" alt="page image" />
        </p>

        <p>
          WORBLI provides fertile ground for applications to be able to develop,
          innovate and prosper within the ever-changing regulatory environment.
          We make compliance easy, affordable and within reach for small and
        ...
        <p>
          We take the guesswork and additional costs out of ensuring legitimate
          verified users through our easy to follow portal interface.
        </p>
        ...
        <p>
          ...
          knowing your bottom line. WORBLI's resource model ensures that people
          can operate freely within the ecosystem without having to pay
        ...
        <p>
          With a vast array of infrastructure upgrades including social sign-in,
          payment processors, and easy to navigate developer tools, WORBLI makes
          building your application seamless from start to finish. Intuitive UX
          &amp; UI, Optimized for Simplicity.
        </p>
        ...
        <p>
          ...
          Disputes are handled within the system ensuring both applications and
          customers feel safe and secure with all the rights they would have
        ...
        <p>
          Do you have a product that is only available to accredited investors?
          Do you want to launch an STO or a token that is only available in
          certain locations? WORBLI has you covered with unique token registries
          allowing the most stringent of processes to be built right into the
          token itself.
        </p>

        <h4 id="ourpartnersandsuiteofapplicationscanalsoleverageexpertlevelconsultingfor">
          Our partners and suite of applications can also leverage expert level
          consulting for...
        </h4>
