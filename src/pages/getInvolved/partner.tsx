  ...
  return (
    <div className="max-width">
      <span className="body">
        ...
        <h3>
          as we strive through collaboration with integrity to deliver the best
          in all we do.
        </h3>

        <p>
          <img src="../images/partner.jpg" alt="page image" />
        </p>

        <p>
          We are always on a mission to find good partners who share our WORBLI
          values. We actively seek out the best applications, technical teams,
        ...
        <p>
          ...
          ethos, we want to work with you. We have a vast array of partners from
          all industries and are always scouting out the next wave. We are
          pioneering the future of innovation one day at a time and we invite
          you to join us.
        </p>

        <p>
          Ethics, versatility, and service. No project too big or small. We
          welcome everyone to reach out and initiate a conversation. Together we
          can shape a fast, resilient infrastructure, that will bring digital
          assets to the masses, allowing businesses to innovate the future of
          DeFi technology.
        </p>
        ...
        {sent && 
        <h4 className="form--title">Your enquiry has been sent! We will be in contact soon.</h4>
        }
        {!sent &&
            ...
            <div>
              <button className="form--button">
                {!loading ? (
                  ...
                  <img src={loadingImg} alt="loading" className="form--loading" />
                )}
              </button>
            </div>
          </div>
