  ...
  return (
    <div className="max-width">
      <span className="body">
        ...
        <p>
          <img src="../images/differences.jpg" alt="page image" />
        </p>
        ...
        <h4>
          The WORBLI Token Protocol creates rulesets at the token level enabling
          security and functionality that would normally have to be built
          in at the app or chain layers.
        </h4>
        ...
        <ul>
          ...
          <li>
            The WORBLI Application Store. All users will have access to a family
            of applications that are being created on the WORBLI Blockchain
          </li>
        </ul>
      </span>
    </div>
